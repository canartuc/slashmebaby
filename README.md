...
- **Tab switching.** Fuzzy-search every open tab in every window and jump to it with Enter. Sleeping (Memory-Saver) tabs show a "zzz" badge and wake automatically when you switch to them.
