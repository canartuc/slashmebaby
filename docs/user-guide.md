...
2. **Try it out** -- Practice using your chosen shortcut on a real page.
...
Tabs are scored by a combination of fuzzy match quality and recency. Tabs you accessed recently appear higher in results.
...
Search the last 1,000 items from your browsing history. Results show the page title, URL, and are ranked by recency (recently visited pages score higher).
...
| Recently Closed | View and restore recently closed tabs |
...
|----------|-------------|
| Alt + Space (default) | Open the command bar |
...
| Backspace (on empty input) | Close the command bar |
...
- **Keyboard Shortcut**: Choose from Alt+Space, Ctrl+Shift+L, Ctrl+., or Ctrl+/
